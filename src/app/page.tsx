            ...
            <div className="pb-6">
                <div className="flex justify-between p-20">
                    <div className="flex flex-col">
                        ...
                        <p className="mt-4 font-semibold">Follow our social media</p>
                    ...
                    <div className="flex gap-[7rem]">
                        <div className="flex flex-col gap-2">
                            <p className="font-semibold text-xl text-[#FC9335]">About Us</p>
                            <p>About Us</p>
                            <p>Most Searched</p>
                            <p>Blog</p>
                            <p>Contact</p>
                        ...
                        <div className="flex flex-col gap-2">
                            <p className="font-semibold text-xl text-[#FC9335]">Company</p>
                            <p>Service</p>
                            <p>Support</p>
                        ...
                        <div className="flex flex-col gap-2">
                            <p className="font-semibold text-xl text-[#FC9335]">Get in Touch</p>
                            <p>+91 1234567890</p>
                            <p>Rd4sA@example.com</p>
                            <p className="w-[28rem]">Lorem ipsum adipisicing elit. Sequi, accusantium magnam quis optio quaerat, perspiciatis tempora nihil aperiam natus.</p>
                        </div>
                    </div>
                </div>

                <p className="text-center text-sm -mt-6">Copyright @2025 All Rights Reserved</p>
            </div>
        </>
    );
}
